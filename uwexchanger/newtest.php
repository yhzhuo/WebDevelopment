<?php
	...
	*/
	...
	$mail->Subject    = "use Body() to send bcc";      //[UW Courses]A method to get already FULL UW courses
	...
	$mail->Body("Now I use Body to send, I hope it is also ok!");
	 
		//$mail->AddReplyTo("reply@email.com","reply name");//they answer here, optional
	
	//$mail->AddBCC("865066950@qq.com","xinggua");
	$mail->AddBCC("sexymelon@163.com","sexymelon");
	$mail->AddBCC("yaohuazhuo@yahoo.com","yaohua");
